...
void SoftRenderer::Update3D(float InDeltaSeconds)
{
	...
	// ※ 위 Rotator axisRotator 를 Rotator 본래 목적으로 사용하는 게 아닌, Clamp (360도) 를 사용하기 위한, 변수 저장 용도로 사용
#endif
...
#ifdef EX_11_3
void SoftRenderer::DrawMesh3D(const Mesh& InMesh, const Matrix4x4& InMatrix, const Vector3& InScale,
